  ...
  return (
    <section className="min-w-0 rounded-2xl border border-border bg-card p-3.5 shadow-soft transition-all hover:-translate-y-0.5 hover:shadow-elevated sm:p-5">
      ...
      <div className="grid gap-3 pt-3 sm:grid-cols-[minmax(220px,0.85fr)_minmax(0,1.6fr)] sm:gap-5">
        <div className="flex min-w-0 items-center gap-3 rounded-xl border border-intelligence-accent/55 border-l-[3px] bg-card p-3 shadow-soft sm:gap-4 sm:p-4">
        <div className="relative grid h-[76px] w-[76px] shrink-0 place-items-center sm:h-24 sm:w-24">
          ...
          <span className="text-xl font-bold tabular-nums text-sucasa-navy sm:text-3xl">{score ? value : "—"}</span>
        </div>
        <div className="min-w-0 text-left">
          <p className="text-[10px] font-bold uppercase text-intelligence-accent">Home Score</p>
...
function CareCard({ topPlanItem, planCount, documentCount, historyCount }: { topPlanItem: { title: string; why: string } | null; planCount: number; documentCount: number; historyCount: number }) {
  return (
    <section className="rounded-2xl border border-border border-t-2 border-t-sucasa-orange bg-card p-3.5 shadow-soft transition-all hover:-translate-y-0.5 hover:shadow-elevated sm:p-5">
      <p className="text-lg font-bold text-sucasa-navy sm:text-xl">Home Care</p>
      <Tabs defaultValue="todo" className="mt-0.5">
        <TabsList className="grid h-11 w-full grid-cols-3 rounded-xl bg-secondary p-1"><TabsTrigger value="todo" className="h-9 rounded-lg px-1 shadow-none data-[state=active]:bg-sucasa-orange data-[state=active]:text-sucasa-orange-foreground data-[state=active]:shadow-soft">To do</TabsTrigger><TabsTrigger value="documents" className="h-9 rounded-lg px-1 shadow-none data-[state=active]:bg-sucasa-orange data-[state=active]:text-sucasa-orange-foreground data-[state=active]:shadow-soft">Documents</TabsTrigger><TabsTrigger value="history" className="h-9 rounded-lg px-1 shadow-none data-[state=active]:bg-sucasa-orange data-[state=active]:text-sucasa-orange-foreground data-[state=active]:shadow-soft">History</TabsTrigger></TabsList>
